...
<div class="flex h-screen items-center justify-center bg-ink p-10 text-white">
	<div class="w-[460px] max-w-full">
		...
		{#if isNotFound}
			...
			<p class="mb-7 text-[14px] leading-relaxed text-[#a8a1ab]">
		...
		<div class="flex flex-wrap items-center gap-3">
			...
			<button
				...
				class="inline-flex h-11 items-center justify-center rounded-control border border-[#312c37] px-6 text-[14px] font-medium text-[#cdbab8] hover:text-white"
			>
				Go back
			</button>
		</div>
