...
const leads: (typeof crmLeads.$inferInsert)[] = [
	...
	{
		id: L(3),
		name: 'ENHYPEN Philippines Fan Fair',
		category: 'Fan Fair',
		platform: 'Twitter/X',
		stage: 'replied',
		source: 'scraper',
	...
	{
		id: L(9),
		name: 'Cagayan Convention Center',
		category: 'Convention',
		platform: 'Facebook',
		location: 'Cagayan',
		stage: 'new',
	...
	{
		id: L(12),
		name: 'Batangas Beach Resort Event',
		category: 'Resort',
		platform: 'Instagram',
		location: 'Batangas',
		stage: 'replied',
	...
	},
	{
		...
		ownerId: U.JOHN,
		lastActivityAt: daysAgo(10),
		dealValueCents: 300000,
		currency: 'PHP',
		wonOrgName: 'Iloilo OKK Productions',
		signedAt: daysAgo(10)
	},
	{
		id: L(16),
		name: 'Davao Fan Fair 2025',
		category: 'Fan Fair',
		platform: 'Twitter/X',
		location: 'Davao',
		stage: 'lost',
	...
	{
		id: L(18),
		name: 'Pangasinan Convention Expo',
		category: 'Convention',
		platform: 'Facebook',
		location: 'Pangasinan',
		stage: 'new',
	...
	{
		id: L(19),
		name: 'Zamboanga Live Band Festival',
		category: 'Live Band',
		platform: 'Instagram',
		location: 'Zamboanga',
		stage: 'new',
...
const activities: (typeof crmActivities.$inferInsert)[] = [
	...
	},
	{
		...
		followUpAt: todayEndManila,
		notes: 'Sent event inquiry.'
	},
	{
		id: A(3),
		leadId: L(3),
		...
		followUpAt: null,
		notes: 'Called — rep confirmed interest.'
	},
	{
		id: A(4),
		leadId: L(4),
		...
		followUpAt: null,
		notes: 'Sent first contact. No response.'
	},
	{
		id: A(5),
		leadId: L(5),
	...
	},
	{
		...
		notes: 'Followed up on expo enquiry.'
	},
	{
		id: A(7),
		leadId: L(7),
	...
	},
	{
		...
		occurredAt: daysAgo(2),
		followUpAt: null,
		notes: 'They replied — interested in package.'
	},
	{
		id: A(10),
		leadId: L(15),
	...
	},
	{
		...
		followUpAt: null,
		notes: 'Call — they want a meeting.'
	},
	{
		id: A(14),
		leadId: L(24),
		...
		occurredAt: daysAgo(5),
		followUpAt: null,
		notes: 'Met in person. Discussing contract.'
	},
	{
		id: A(15),
		leadId: L(25),
