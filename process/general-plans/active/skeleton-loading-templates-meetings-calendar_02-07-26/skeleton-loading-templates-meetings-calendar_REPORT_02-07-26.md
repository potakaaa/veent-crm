...
- Verified: AC4 (automated). AC1/AC2/AC3/AC5 verified structurally at code level ONLY — the structural PASS is SUPERSEDED (a later plan's real-browser check found the calendar skeleton near-invisible; 35→42 cell count since corrected). Live-browser confirmation still outstanding.
